# Generated by Django 3.0.7 on 2020-06-14 00:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to=blog.models.author_avatar_file_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField()),
                ('modified_at', models.DateTimeField()),
                ('author', models.ManyToManyField(related_name='social_accounts', to='blog.Author')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cover_image', models.ImageField(blank=True, null=True, upload_to=blog.models.post_image_file_path)),
                ...
                ('file_type', models.CharField(choices=[('HTML', 'HTML'), ('MARKDOWN', 'MARKDOWN')], default='HTML', max_length=25)),
                ('created_at', models.DateTimeField()),
                ('modified_at', models.DateTimeField()),
